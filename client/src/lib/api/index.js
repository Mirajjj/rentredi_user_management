 ...
 * instance. Add a resource by writing `endpoints/<name>.js` and spreading its
 * factory here — no call site changes. A plain function returning a plain
 * object (no class, no `this`), so methods stay trivial to move into their own
 * files.
